...
\date{Введение в нейронные сети | 25.01.2025}
...
\begin{frame}{Вспоминаем линейную регрессию}
    \centering{\includegraphics[width=.7\linewidth]{figures/fig2.png}}
...
{
    \usebackgroundtemplate{\includegraphics[width=\paperwidth]{figures/fig6.jpg}}
    \begin{frame}
    \end{frame}
}
